...
export class basanta1647867870873 implements MigrationInterface {
    name = 'basanta1647867870873'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "students" ("slug" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "student_name" character varying NOT NULL, "DOB" character varying NOT NULL, "mark_optained" integer NOT NULL, CONSTRAINT "UQ_714c54a719be0ef67f442ed1d80" UNIQUE ("slug"), CONSTRAINT "PK_7d7f07271ad4ce999880713f05e" PRIMARY KEY ("id"))`);
